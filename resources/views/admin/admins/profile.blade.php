                        ...
                        @slot('content')
                            <div class="row mb-2">
                                <div class="text-center">
                                    <img class="rounded-circle image-preview position-relative" width="200" height="200"
                                        alt="" src="{{ asset($resource->image ?? '/assets/images/profile/user-1.jpg') }}">
                                    <label for="fileid" style="left: 46%;top: 55%;" class="position-absolute fw-bolder fs-6">
                                        <span class="ti ti-upload"></span>
                                    </label>
                                    <input type="file" id="fileid" style="display: none" class="image form-control"
                                        name="image">
