                        ...
                        <div class="contact__wrapper">
                            <div class="section__title-wrapper mb-40">
                                ...
                                <div>
                                    ...
                                    لكل طالب محفظة داخل المنصة يستطيع شراء فيديوهات الحصص من خلالها ، و يتم خصم قيمة الحصة
                                    من المحفظة تلقائياً بعد الشراء و لا يمكن استرداد القيمة المدفوعة بعد عملية الشراء
                                </div>
                                <div>
                                    و يتوافر على المنصة فيديوهات شرح لكافة فصول المنهج و أيضاً فيديوهات حل أسئلة سواء من كتب
                                    خارجية أو من ملزمة Easy Bio

                                </div>
                                <div>
                                    ملحوظة هامة : بعد الشراء يتم توفير الحصة للطالب لمدة لا تتجاوز ال١٠ ساعات كحد أقصى (مع
                                    العلم أن الحصة لا تتجاوز ال٣ ساعات) ثم بعدها يتم اغلاق الحصة ؛ لذا يجب على الطالب شراء
                                    الحصة فقط عند استعداده لمشاهدتها و هذا حتى لا يحدث تراكم للحصص
                                ...
                                <div>
                                    يقوم الطالب بإنشاء حساب جديد على المنصة ثم يتم الدفع عن طريق عن طريق فودافون كاش و بعدها
                                    يتم التواصل مع تيم المنصة هاتفياً أو على الواتساب لشحن رصيد المحفظة
                                ...
                                <div>
                                    ...
                                    ملحوظة هامة جداً : عزيزي الطالب ممنوع منعاً باتاً طلب استرجاع النقود المدفوعة للمحفظة و
                                    لا يتم ارجاع أي نقود للطالب بعد التحويل و التفعيل ، شكراً لحسن تفهمكم و عام سعيد بإذن
                                    الله
                                </div>
