...
لكل طالب محفظة داخل المنصة يستطيع شراء فيديوهات الحصص من خلالها ، و يتم خصم قيمة الحصة من المحفظة تلقائياً بعد الشراء و لا يمكن استرداد القيمة المدفوعة بعد عملية الشراء
و يتوافر على المنصة فيديوهات شرح لكافة فصول المنهج و أيضاً فيديوهات حل أسئلة سواء من كتب خارجية أو من ملزمة Easy Bio

ملحوظة هامة : بعد الشراء يتم توفير الحصة للطالب لمدة لا تتجاوز ال١٠ ساعات كحد أقصى (مع العلم أن الحصة لا تتجاوز ال٣ ساعات) ثم بعدها يتم اغلاق الحصة ؛ لذا يجب على الطالب شراء الحصة فقط عند استعداده لمشاهدتها و هذا حتى لا يحدث تراكم للحصص


- كيفية الدفع لمشاهدة فيديوهات Easy Bio ؟

يقوم الطالب بإنشاء حساب جديد على المنصة ثم يتم الدفع عن طريق عن طريق فودافون كاش و بعدها يتم التواصل مع تيم المنصة هاتفياً أو على الواتساب لشحن رصيد المحفظة
