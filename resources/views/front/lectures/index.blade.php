                ...
                <div class="row">
                    <div class="col-xxl-12">
                        <div class="page__title-wrapper mt-110">
                            <h3 class="page__title">{{ __('lang.lectures') }}</h3>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('front.home') }}">{{ __('lang.home') }}</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">{{ __('lang.lectures') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="course__tab-conent">
                            <div class="tab-content" id="courseTabContent">
                                <div class="tab-pane fade show active" id="grid" role="tabpanel"
                                    ...
                                    <div class="row">
                                        @foreach ($resource->lectures()->where('active', 1)->get() as $item)
                                                ...
                                                <div class="course__item white-bg mb-30 fix">
                                                    <div class="course__thumb w-img p-relative fix">
                                                        ...
                                                        <div class="course__tag">
                                                            <a href="#">{{ optional($item->course)->title }}</a>
                                                        </div>
                                                    </div>
