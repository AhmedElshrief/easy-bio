                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('student.login') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="username" autocomplete="new-mail" placeholder="ahmed123" name="username"
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="password" class="form-control @error('password') is-invalid @enderror"
                                        name="password" placeholder="********" id="exampleInputPassword1"
                                ...
                                <div class="d-flex align-items-center justify-content-end mb-3">
                                    ...
                                    <button type="submit"
                                        class="btn btn-primary w-100 py-8 fs-4 mb-1 rounded-2">{{ __('lang.login') }}</button>
                                </div>
                                <a href="{{ route('student.register') }}"
                                    class="btn btn-info w-100 py-8 fs-4 mb-2 rounded-2">{{ __('lang.create_account') }}</a>
